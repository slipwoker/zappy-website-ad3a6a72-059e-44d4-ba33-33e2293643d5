    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: 'ad3a6a72-059e-44d4-ba33-33e2293643d5',
            name: fullName,
            email: email,
            subject: 'טופס יצירת קשר - כיסוי שיניים לכולם',
            message: `שם מלא: ${fullName}\nאימייל: ${email}\nטלפון: ${phone}\nגודל משפחה: ${familySize}\n\nהודעה:\n${message}`,
            phone: phone
          };
      ...
      alert('תודה שפניתם אלינו! נציג שלנו יחזור אליכם בהקדם.');
      contactForm.reset();
    });
  }
});
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "כיסוי שיניים לכולם משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
